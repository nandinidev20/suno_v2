...
export const AuthProvider = ({ children }) => {
  ...
  const verifyForgotPasswordOtp = async (email, otp) => {
    try {
      const response = await axios.post('/api/auth/forgot-password/verify-otp', { email, otp });
  ...
  const resetPassword = async (email, otp, newPassword) => {
    try {
      const response = await axios.post('/api/auth/forgot-password/reset', { email, otp, newPassword });
